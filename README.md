...
1. **Install dependencies** (npm workspaces):
  ```bash
   npm install
  ```
2. **Create a Supabase project** at [https://supabase.com](https://supabase.com) (free tier).
...
6. **Run the app:**
  ```bash
   npm run dev
  ```
   Open [http://localhost:3000](http://localhost:3000) — sign up, then land on the (empty) dashboard.
